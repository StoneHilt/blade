    ...
    public static function provider_renderOpening(): array
    {
        return [
            [
                ...
                'action'     => '/page/1',
                'attributes' => [],
                'csrfInput'  => '<input type="hidden" name="_csrf" value="a1b2c3d4e5f6" />',
            ...
            [
                ...
                'attributes' => [],
                'csrfInput'  => '<input type="hidden" name="_csrf" value="a1b2c3d4e5f6" />',
                'expected'   => '<form method="POST" action="/page/2"><input type="hidden" name="_csrf" value="a1b2c3d4e5f6" />',
            ],
            [
                'method'     => 'PUT',
                'action'     => '/page/3',
                'attributes' => [],
                'csrfInput'  => '<input type="hidden" name="_csrf" value="a1b2c3d4e5f6" />',
                'expected'   => '<form method="POST" action="/page/3"><input type="hidden" name="_method" value="PUT" /><input type="hidden" name="_csrf" value="a1b2c3d4e5f6" />',
            ],
            [
                'method'     => 'PATCH',
                'action'     => '/page/4',
                'attributes' => [],
                'csrfInput'  => '<input type="hidden" name="_csrf" value="a1b2c3d4e5f6" />',
                'expected'   => '<form method="POST" action="/page/4"><input type="hidden" name="_method" value="PATCH" /><input type="hidden" name="_csrf" value="a1b2c3d4e5f6" />',
            ],
            [
                'method'     => 'DELETE',
                'action'     => '/page/5',
                'attributes' => [],
                'csrfInput'  => '<input type="hidden" name="_csrf" value="a1b2c3d4e5f6" />',
                'expected'   => '<form method="POST" action="/page/5"><input type="hidden" name="_method" value="DELETE" /><input type="hidden" name="_csrf" value="a1b2c3d4e5f6" />',
            ],
            [
                'method'     => 'POST',
                'action'     => '/page/2',
                ...
                'csrfInput'  => '<input type="hidden" name="_csrf" value="a1b2c3d4e5f6" />',
                'expected'   => '<form id="the-id" method="POST" action="/page/2"><input type="hidden" name="_csrf" value="a1b2c3d4e5f6" />',
            ],
        ];
    }
}
